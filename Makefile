...
#### Main build
# For regular CLI build, we link the hdfs extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/hdfs/hdfs.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/hdfs/hdfs.duckdb_extension'
